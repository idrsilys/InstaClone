...
#ifndef INSTACLONEFIREBASE_SWIFT_H
#define INSTACLONEFIREBASE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="InstaCloneFirebase",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18InstaCloneFirebase11AppDelegate")
...
SWIFT_CLASS("_TtC18InstaCloneFirebase8FeedCell")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified documentIdLabel;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC18InstaCloneFirebase18FeedViewController")
...
SWIFT_CLASS("_TtC18InstaCloneFirebase13SceneDelegate")
...
SWIFT_CLASS("_TtC18InstaCloneFirebase22SettingsViewController")
...
SWIFT_CLASS("_TtC18InstaCloneFirebase20UploadViewController")
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified coomentText;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified uploadButton;
- (void)viewDidLoad;
- (void)chooseImage;
- (void)imagePickerController:(UIImagePickerController * _Nonnull)picker didFinishPickingMediaWithInfo:(NSDictionary<UIImagePickerControllerInfoKey, id> * _Nonnull)info;
- (IBAction)actionButtonClicked:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC18InstaCloneFirebase14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified emailText;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified passswprdText;
- (void)viewDidLoad;
- (IBAction)signInClicked:(id _Nonnull)sender;
